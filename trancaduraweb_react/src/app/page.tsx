    ...
    <div className="bg-gray-50 min-h-screen font-sans overflow-x-hidden">
        ...
        <div className="relative z-20 text-center px-6 max-w-5xl mx-auto flex flex-col items-center">
          ...
          <div className="h-16 mb-6 flex items-center justify-center">
            <TypeAnimation
              ...
              wrapper="span"
              speed={50}
              style={{ fontSize: '1.5rem', display: 'inline-block', fontWeight: 'bold', color: '#60A5FA' }} // cor blue-400
              repeat={Infinity}
            />
          </div>
      ...
      <section id="solutions" className="py-16 md:py-20 px-4 md:px-8 max-w-7xl mx-auto -mt-16 md:-mt-24 relative z-30">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <Link href="/dashboard/metering" className="group h-full block animate-float-delay">
      ...
      <footer className="bg-blue-950 text-gray-300 py-10 border-t border-blue-900">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-gray-400">Instituto Federal de Sergipe - Campus Lagarto</p>
          </div>
