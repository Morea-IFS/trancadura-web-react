    ...
    <div>
      ...
      <section className="p-4">
        <div className="w-full mx-auto max-w-4xl p-4 flex items-center justify-center flex-col gap-1">
          ...
          <p className="font-bold text-base sm:text-lg md:text-xl text-gray-600">
            Use o botão abaixo para controlar a tranca
          </p>
        </div>

        <div className="flex items-center justify-center w-full">
          <div className="flex flex-col gap-4 items-center justify-center w-88 md:w-120 p-12 bg-white rounded-lg shadow-md border border-gray-200">
