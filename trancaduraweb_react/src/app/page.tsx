...
export default function Home() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative min-h-[500px] md:h-[600px] flex items-center justify-center bg-gray-900 text-white pb-20 pt-10 md:pt-0">
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 z-0 animate-gradient-xy"></div>
        <div className="absolute inset-0 bg-[url('/assets/grid-pattern.png')] opacity-10 z-0"></div>
        ...
        <div className="relative z-20 text-center px-6 max-w-5xl mx-auto flex flex-col items-center">
          ...
          <p className="text-base md:text-2xl text-gray-300 mb-10 max-w-2xl leading-relaxed mx-auto">
            O projeto <strong>MOREA</strong> une segurança física e eficiência energética através de soluções modulares de baixo custo e código aberto.
          </p>
      ...
      {/* Seção de Soluções */}
      <section id="solutions" className="py-16 md:py-20 px-4 md:px-8 max-w-7xl mx-auto -mt-16 md:-mt-24 relative z-30">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          
          {/* Card Trancadura */}
          <Link href="/trancadura" className="group h-full block"> 
            <div className="bg-white/95 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-xl border border-white/50 hover:border-blue-200 transition duration-500 transform hover:-translate-y-2 h-full flex flex-col relative overflow-hidden">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4 group-hover:text-blue-700 transition">Trancadura 2.0</h2>
              <p className="text-gray-600 mb-6 md:mb-8 text-base md:text-lg leading-relaxed flex-grow">
                Sistema de controle de acesso modular. Gerencie laboratórios, permissões via RFID/App e logs de auditoria.
              </p>
          ...
          {/* Card Sparc */}
          <Link href="/dashboard/metering" className="group h-full block">
            <div className="bg-white/95 backdrop-blur-xl p-8 md:p-10 rounded-3xl shadow-xl border border-white/50 hover:border-teal-200 transition duration-500 transform hover:-translate-y-2 h-full flex flex-col relative overflow-hidden">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4 group-hover:text-teal-700 transition">Sparc Monitor</h2>
              <p className="text-gray-600 mb-6 md:mb-8 text-base md:text-lg leading-relaxed flex-grow">
                Monitoramento inteligente de recursos. Visualize gráficos de consumo de energia e água em tempo real.
              </p>
      ...
      <section id="about" className="py-16 md:py-24 px-4 md:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16 md:mb-24">
            <h2 className="text-3xl md:text-5xl font-bold text-gray-900 mb-4 md:mb-6">Tecnologia com Propósito</h2>
            ...
            <p className="mt-6 text-lg md:text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed">
              Desenvolvido no IFS Campus Lagarto, o Morea busca resolver problemas reais de segurança e desperdício utilizando hardware acessível e software moderno.
            </p>
          </div>
          ...
          {/* Integração Hardware & Software (Texto Introdutório) */}
          <div className="text-center mb-16 md:mb-20 max-w-4xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-bold text-gray-800 mb-6">
              Ecossistema Integrado
            </h3>
            <p className="text-gray-600 text-base md:text-lg leading-relaxed">
              O sistema utiliza uma arquitetura moderna para garantir escalabilidade. No hardware, sensores de vazão e módulos RFID conectam-se ao microcontrolador <strong>ESP32</strong>. No servidor, uma API robusta processa requisições em tempo real, gerenciando permissões de acesso e acumulando dados de telemetria.
            </p>
          </div>

          {/* Detalhe SPARC (Imagem Esquerda / Texto Direita) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-24 md:mb-32">
             <div className="order-1 lg:order-1 relative h-64 md:h-80 rounded-2xl overflow-hidden shadow-2xl group bg-gray-100 border border-gray-200">
                <div className="absolute inset-0 flex items-center justify-center group-hover:scale-105 transition duration-700 bg-gradient-to-br from-teal-50 to-teal-100">
                   <MdWaterDrop className="text-8xl text-teal-300" />
                </div>
                <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur px-4 py-2 rounded-lg shadow-sm">
                  <p className="text-teal-800 font-bold text-sm">Sensor Sparc (Água)</p>
                </div>
             </div>
             ...
             <div className="order-2 lg:order-2 space-y-4">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900">Sparc: Monitoramento Inteligente</h3>
                <p className="text-gray-600 text-lg leading-relaxed">
                  O Sparc utiliza sensores não invasivos para medir o consumo de energia elétrica e fluxo de água em tempo real. Os dados são enviados para o servidor a cada 5 minutos, permitindo a detecção precoce de vazamentos e o acompanhamento de metas de economia.
                </p>
                <ul className="space-y-2 mt-2 text-gray-500">
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-teal-500 rounded-full"></div> Sensor de Fluxo YF-S201</li>
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-teal-500 rounded-full"></div> Medição de Corrente SCT-013</li>
                </ul>
             </div>
          </div>

          {/* Detalhe TRANCADURA (Texto Esquerda / Imagem Direita) */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
             <div className="order-2 lg:order-1 space-y-4">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900">Trancadura: Controle de Acesso</h3>
                <p className="text-gray-600 text-lg leading-relaxed">
                  A Trancadura substitui chaves físicas por cartões RFID e controle via aplicativo. O sistema mantém um log auditável de quem entrou em cada laboratório e quando, além de permitir o bloqueio remoto de portas em caso de emergência.
                </p>
                <ul className="space-y-2 mt-2 text-gray-500">
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-blue-500 rounded-full"></div> Leitor RFID MFRC522</li>
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-blue-500 rounded-full"></div> Solenóide 12V com Relé</li>
                </ul>
             </div>

             <div className="order-1 lg:order-2 relative h-64 md:h-80 rounded-2xl overflow-hidden shadow-2xl group bg-gray-100 border border-gray-200">
                ...
                <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur px-4 py-2 rounded-lg shadow-sm">
                  <p className="text-blue-800 font-bold text-sm">Protótipo Trancadura</p>
                </div>
             </div>
          </div>
      ...
      <footer className="bg-blue-950 text-gray-300 py-10 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
          
          <div className="text-center md:text-left">
            <h4 className="text-xl font-bold text-white mb-2">Projeto MOREA</h4>
            <p className="text-sm text-gray-500">Instituto Federal de Sergipe - Campus Lagarto</p>
          </div>

          <div className="flex items-center gap-6">
            <div className="relative  bg-white rounded-lg p-2 flex items-center justify-center">
               <Image 
...
function FeatureCard({ icon, title, desc, color }: { icon: React.ReactNode, title: string, desc: string, color: string }) {
  ...
  return (
    <div className="p-6 rounded-2xl bg-gray-50 border border-gray-100 hover:shadow-lg transition duration-300 h-full">
      <div className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl mb-4 ${colorClasses[color]}`}>
        {icon}
      </div>
